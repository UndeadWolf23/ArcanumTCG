...
BUILTIN_SPECS: tuple[CardSpec, ...] = (
    ...
    # -------------------------------------------------------- relics (4)
    _spec("r_wheel", "Wheel of Fortune", CardType.RELIC, Rarity.RARE,
          cost=3, keywords=(("fortune", None),),
          text="Fortune — Draw a card.",
          flavor="It only spins for the desperate."),
    _spec("r_doomsigil", "Doom Sigil", CardType.RELIC, Rarity.EPIC,
          cost=2, keywords=(("countdown", 3),),
          text="Countdown — Deal 4 damage to the enemy champion, then "
               "destroy this relic.",
          flavor="Three turns. It is always three turns."),
    _spec("r_warbanner", "War Banner", CardType.RELIC, Rarity.UNCOMMON,
          cost=2, keywords=(("empower", None),),
          text="Empower — Your heroes get +1/+0 until end of turn.",
          flavor="Cloth, pole, and the promise of glory."),
    _spec("r_reliquary", "Sealed Reliquary", CardType.RELIC,
          Rarity.UNCOMMON, cost=1,
          keywords=(("relicbound_relic", None), ("salvage", None),
                    ("tribute", None)),
          text="Tribute — Gain 1 energy.",
          flavor="Whatever is inside wants to stay there."),
    ...
    _spec("t_gravecaller", "Gravecaller Wisp", CardType.HERO,
          Rarity.UNCOMMON, cost=2, attack=2, health=1,
          hero_types=["Ghost", "Summoner"],
          keywords=(("reanimate", 2),),
          flavor="Death is a door it keeps propping open."),
    _spec("t_sage", "Sage of the Spire", CardType.HERO, Rarity.RARE,
          cost=3, attack=1, health=4, hero_types=["Wizard", "Oracle"],
          keywords=(("intelligent", None),),
          flavor="Every wound teaches her something."),
    _spec("t_stoneheart", "Stoneheart Colossus", CardType.HERO,
          Rarity.RARE, cost=4, attack=2, health=3,
          hero_types=["Golem", "Knight"],
          keywords=(("charged", 2), ("relicbound_hero", None)),
          flavor="Its heart is the vault; its body, the lock."),
